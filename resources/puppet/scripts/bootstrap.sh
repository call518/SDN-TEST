...
#puppet module install --force puppet module install maestrodev-ssh_keygen
...
puppet module install --force /vagrant/resources/puppet/files/maestrodev-ssh_keygen-1.2.0.tar.gz --ignore-dependencies
